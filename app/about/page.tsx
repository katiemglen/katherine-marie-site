export default function About() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <h1 className="font-[family-name:var(--font-playfair)] text-4xl text-emerald-200 mb-8">About</h1>
      <div className="glass rounded-2xl p-8 space-y-6 text-emerald-100/80 leading-relaxed">
        <p>
          Hi, I&apos;m <span className="text-amber-300">Katie</span> — and this is a collection of stories from
          road trips I&apos;ve taken across the United States.
        </p>
        <p>
          In <strong className="text-emerald-300">2016</strong>, my partner Chad and I packed a diesel Jetta and drove
        ...
        <p>
          In <strong className="text-emerald-300">2019</strong>, we hit the East Coast — exploring history, beaches,
