  ...
  return (
    ...
    >
      <TiltCard className="cursor-pointer overflow-hidden rounded-xl will-animate relative group">
        <ProgressiveImage src={wpImage(images[0], IMG_SIZES.fullBleed)} alt="" className="w-full hover:scale-[1.02] transition-transform duration-700" onClick={() => onImageClick(0)} />
      </TiltCard>
    </motion.div>
  );
}
